    ...
    return Obx(
      () {
        if ((controller.isLoading.value) &&
          ...
          if ((arabicController.surahResponse.value.data.ayahs.isNotEmpty) &&
                      ...
                      children: [
                        Row(
                          children: [
                            Expanded(
                              child: Text(
                                textDirection: arabicController.surahResponse
                                            .value.data.edition.direction ==
                                        null
                                    ? TextDirection.rtl
                                    : TextDirection.ltr,
                        ...
                        Text(
                          textDirection: controller.surahResponse.value.data
                              ...
                              : TextDirection.ltr,
                          controller
                              .surahResponse.value.data.englishNameTranslation,
                          style: TextStyle(
                            // fontFamily: "SourGummy",
                            color: Colors.white,
                            fontSize: 16.sp,
